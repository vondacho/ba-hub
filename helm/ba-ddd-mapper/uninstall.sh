#!/usr/bin/env bash
#
# Remove the ba-ddd-mapper release.
#
#   ./helm/ba-ddd-mapper/uninstall.sh                 # release only
#   ./helm/ba-ddd-mapper/uninstall.sh --namespace     # and the namespace with it
#
...
# everything else in it — which is not ba-ddd-mapper's to delete: ba-portal is
