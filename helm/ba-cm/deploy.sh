#!/usr/bin/env bash
#
# Build, install and verify ba-cm on a local cluster.
#
#   ./helm/ba-cm/deploy.sh              # build, upgrade, restart, test
#   ./helm/ba-cm/deploy.sh --no-build   # skip the image build
#   ./helm/ba-cm/deploy.sh --no-test    # skip helm test
#
# Environment overrides:
#   NAMESPACE  (default ba-hub)
#   RELEASE    (default ba-cm)
