...
The **Context mapper**. A context map authored as text in one panel and drawn as a
...
In **ba-cm the text is the source of truth** and the graph is a render of it.
...
- **No conformance.** ba-portal describes the Context mapper as also ingesting
