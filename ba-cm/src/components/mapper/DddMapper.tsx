...
export default function DddMapper({ promptsUrl }: Props) {
	 ...
	 * context's model opened from it — and two tabs both called "Context mapper" are
	...
	useEffect(() => {
		window.document.title = document_.title
			? `${document_.title} · map — Context mapper`
			: 'Context mapper — ba-hub';
	}, [document_.title]);
