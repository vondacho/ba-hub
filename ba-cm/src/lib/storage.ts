...
const THEME = 'ba-cm:graph-theme';
const SPLIT = 'ba-cm:split';
const PANES = 'ba-cm:panes';
const LEGEND = 'ba-cm:legend';
...
const LAST_MAP = 'ba-cm:last-map';
const LAST_MODEL = 'ba-cm:last-model';

/** The keys the entries before per-document naming lived under. */
const LEGACY_SOURCE = 'ba-cm:source';
const LEGACY_POSITIONS = 'ba-cm:positions';
const LEGACY_CURVES = 'ba-cm:curves';
const LEGACY_MODEL_SOURCE = 'ba-cm-model:source';
const LEGACY_MODEL_POSITIONS = 'ba-cm-model:positions';
